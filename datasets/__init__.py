from datasets import denmark_points, denmark_shapes, denmark_stacked, denmark_cob, denmark_all, trancos, voc
...
def getDataset(name, path, images, object_type, n_classes, transform):
    ...
    elif name == 'denmark_stacked':
        dataset = denmark_stacked.Denmark(path, images, object_type, n_classes, transform)
